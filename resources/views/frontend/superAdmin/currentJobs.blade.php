                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="display: flex;">
                                    <a href="{{ route('edit-Job-Form', ['id' => $job->id]) }}" class="btn btn-primary" style="flex: 1; margin-right: 5px;">Edit</a>
                                    <a href="{{ route('delete-Job', ['id' => $job->id]) }}" class="btn btn-danger" style="flex: 1; margin-left: 5px;">Delete</a>
