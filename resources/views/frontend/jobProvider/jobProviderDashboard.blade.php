...
<body>
  ...
  <!-- ======= Header ======= -->
  @include('frontend.jobProvider.header')
  <!-- End Header -->
  ...
  <aside id="sidebar" class="sidebar" style="">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('jobPostForm')}}">
          <span>Post Job</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('myJobs')}}">
          <span>My Jobs</span>
        </a>
      </li>
       {{--<li class="nav-item">
        <a class="nav-link collapsed" href="{{route('appliedCandidate')}}">
          <span>Applied Candidates</span>
        </a>
      </li>--}}

      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('applicationList')}}">
          <span>Job List</span>
        </a>
      </li>
