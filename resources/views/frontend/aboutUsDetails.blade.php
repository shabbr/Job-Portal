            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="p-4 rounded testimonial-item bg-light">
                        ...
                        <p>Wider reach, faster hires - a game-changer for recruitment.</p>
                    ...
                    <div class="p-4 rounded testimonial-item bg-light">
                        <i class="mb-3 fa fa-quote-left fa-2x text-primary"></i>
                        <p>Streamlined process, easy management - excellent experience</p>
                        <div class="d-flex align-items-center">
                    ...
                    <div class="p-4 rounded testimonial-item bg-light">
                        <i class="mb-3 fa fa-quote-left fa-2x text-primary"></i>
                        <p>Quick and easy job search - find your next opportunity in seconds!</p>
                        <div class="d-flex align-items-center">
                    ...
                    <div class="p-4 rounded testimonial-item bg-light">
                        <i class="mb-3 fa fa-quote-left fa-2x text-primary"></i>
                        <p>Seamless application process - spend less time applying, more time landing interviews</p>
                        <div class="d-flex align-items-center">
