 ...
 @include('layouts.header')
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('appliedJobs')}}">
          <span>Applied Jobs</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('shortlistedRecord')}}">
          <span>Shortlisted Jobs</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('SelectedRecord')}}">
                ...
                <div class="card info-card sales-card">
                 ...
                 <h5 class="card-title">Applied Jobs </h5>
                    ...
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" >
                      <img src="{{asset('images/applications.png')}}" class="bi bi-cart" alt="">
                    </div>
                    <div class="ps-3">
                      <h6> {{$applications}} </h6>
...
<div>
                <div class="card info-card sales-card">
                   <div class="card-body">
                   <h5 class="card-title">Shortlisted Jobs </h5>

                      <div class="d-flex align-items-center">
                      <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                        <img src="{{asset('images/shortlist.webp')}}" class="bi bi-cart" alt="">
                      </div>
                      <div class="ps-3">
                        <h6> {{$shortlisted}} </h6>
...
<div>
                ...
                <div class="card info-card sales-card">
                   <div class="card-body">
                   <h5 class="card-title">Selected Jobs </h5>

                      <div class="d-flex align-items-center">
                      <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                        <img src="{{asset('images/selected.webp')}}" class="bi bi-cart" alt="">
                      </div>
                      <div class="ps-3">
                        <h6> {{$selected}} </h6>
